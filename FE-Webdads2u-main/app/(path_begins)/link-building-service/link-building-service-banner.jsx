            ...
            <div className="container-fluid">
                <div className="row justify-content-center linkbuildingservicebanner">
                    <div className="col-7 col-sm-6 col-md-6 col-lg-5 align-self-center">
                        <h1>Best Link Building <br />
                            Services in India</h1>
                        <p>Link building is crucial for SEO success. It involves acquiring
                            backlinks from reputable websites to improve search engine rankings
                            and increase organic traffic to your site.</p>
                        <a href="/contact-us"><button className='d-none d-sm-block'>Contact us</button></a>
                    </div>
                    <div className="col-5 col-sm-6 col-md-6 col-lg-6 ">
                        <img src="webdads/images/link-building-service/Chain.png" alt="Chain" loading='lazy' className='img-fluid' />  
                        <div>
