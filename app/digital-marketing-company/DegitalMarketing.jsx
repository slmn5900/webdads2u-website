...
import ProjectHighlights from "../Lading-page/ResuabelComponent/ProjectHighlights"
import DigitalMarketingHighlightes from "../Lading-page/ResuabelComponent/DigitalMarketingHighlightes"

export default function DigitalMarketing() {
    const [data, setData] = useState([])
    const fetchData = async () => {
        try {
            const response = await fetch("/api/digital-marketing.json");
            // if (!response.ok) {
