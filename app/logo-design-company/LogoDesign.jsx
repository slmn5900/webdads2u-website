...
import ProjectSliderSection from "../Lading-page/ResuabelComponent/ProjectSliderSection"

export default function LogoDesign() {
    const [data, setData] = useState([])
    const fetchData = async () => {
        try {
            const response = await fetch("/api/logodesign.json");
            // if (!response.ok) {
    ...
    return (
        <div>
            ...
            {/* <ProjectSliderSection data={data} /> */}
