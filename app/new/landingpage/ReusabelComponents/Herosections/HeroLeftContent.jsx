...
const HeroLeftContent = ({ tagline, heading, description, email, phone, button1, button2 }) => (
    <Box maxWidth={{ md: '518px' }}>
        ...
        <TextField placeholder="Name"  size='small' sx={{ width:"84%", mb: 2, '& .MuiOutlinedInput-root': { borderRadius: '8px', background: "white" } }} /> <br />
        <TextField placeholder="Phone Number"  size='small' sx={{width:"84%", mb: 2, '& .MuiOutlinedInput-root': { borderRadius: '8px', background: "white" } }} />
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <Typography sx={{ color: '#1F167B', fontSize: { xs: '16px', md: '20px' }, fontWeight: 500, fontFamily: 'Poppins' }}>{email}</Typography>
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                {/* <Box sx={{ width: 24, height: 24, bgcolor: '#1F167B' }} />
                 */}
                < PhoneIcon sx={{ color: '#1F167B' }} />
                <Typography sx={{ color: '#1F167B', fontSize: { xs: '16px', md: '20px' }, fontWeight: 500, fontFamily: 'Poppins' }}>{phone}</Typography>
            </Box>
        </Box>
    </Box>
);
