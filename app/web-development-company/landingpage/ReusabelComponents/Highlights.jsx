...
//                     <motion.div initial={{ opacity: 0, y: -40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} gap={5}>
//                         <Typography variant="h4" sx={{ fontWeight: 600, fontSize: 32, width: '60%', mb: '40px' }} fontFamily="Poppins" gutterBottom>
//                             {Highlights?.title}
//                         </Typography>
//                         <Button variant="contained" color={Highlights?.cta?.color} sx={{ textTransform: 'uppercase', fontWeight: 600, fontSize: 14 }}>
...
//                                     }}
//                                 >
//                                     <CardMedia component="img" height="400px" image={project.image.url} alt={project.image.alt} />
//                                     <CardContent
//                                         sx={{
...
export default function ProjectShowcase({ data }) {
    ...
    // ✅ If no content, hide the whole section
