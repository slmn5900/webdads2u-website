...
export default function WhyChooseWEBDADS2U(data) {
    ...
    return (
        <Box px={{ xs: 2, sm: 4, md: 10 }} >
            <Grid2 container spacing={{ xs: 0, sm: 0, md: 1 }} justifyContent="center">
                <Grid2 size={{ xs: 12 }} >
                    <Typography
                        variant="body1"
                        color="black"
                ...
                <Grid2 size={{ sm: 12, md: 6 }}>
                    ...
                    >
                        ...
                        <Box sx={{ gap: { xs: 1, sm: 1, md: 3 } }}>

                            {response?.services.map((item, index) =>
                            (

                                <Box mb={4} key={index} sx={{ display: "flex", gap: 2, justifyContent: 'start', alignItems: 'start' }}>
                                    <Box >
                ...
                <Grid2 size={{ xs: 12, sm: 12, md: 6 }} >
                    <Grid2 container spacing={3}>
                        <Box px={isSm ? 2 : 6} py={{ xs: 2, sm: 6, md: 6 }}>
                            <Grid2 container spacing={3} justifyContent="center" position='relative'>



                                {response?.stats?.map((card, index) => (
                                    <Grid2 size={{ xs: 12, sm: 6, md: 6 }} key={index} sx={{
                                        // Apply only on md breakpoint and up
                                        [theme.breakpoints.up('md')]: {
                                            position: "relative",
                                            top: ((index === 1 || index === 3) ? "25px" : 0) || ((index === 0 || index === 2) ? "-25px" : 0)
                                        }
                                    }} >
                                        <MotionPaper
