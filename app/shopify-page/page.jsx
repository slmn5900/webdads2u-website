...
import ShopifyProjectShowcase from '../Lading-page/ResuabelComponent/ShopifyHighlights'

export default function Page() {
    const [data, setData] = useState([])
    const fetchData = async () => {
        try {
            const response = await fetch("/api/shoppify.json");
            // if (!response.ok) {
    ...
    return (
        <Box sx={{ overflow: 'hidden' }}>
            ...
            <ShopifyProjectShowcase data={data} />
