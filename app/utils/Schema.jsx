...
export const organizationSchema = {
    ...
    sameAs: ['https://www.facebook.com/Webdads2u', 'https://www.instagram.com/webdads2u/', 'https://www.linkedin.com/company/webdads2u-private-limited/', 'https://x.com/webdads2u']
};
...
export const localBusinessSchema = {
    ...
    description: 'Webdads2u Pvt Ltd is a professional web development company based in Chennai, India, offering web design, branding, digital marketing, app development, CRM, ERP, and e-commerce solutions with 12+ years of industry experience.',
    telephone: '+91 88256 07550',
    email: 'info@webdads2u.com',
...
export const websiteSchema = {
    ...
    description: 'Webdads2u is a professional web development and digital solutions company in Chennai offering website design, digital marketing, branding, app development, CRM, ERP, and e-commerce solutions.',
    publisher: {
        '@type': 'Organization',
        '@id': organizationSchema['@id']
    },
...
export const webPageSchema = {
    ...
    description: 'Webdads2u Pvt Ltd helps businesses grow with web design, digital marketing, branding, app development, CRM, ERP, and e-commerce solutions.',
...
// Combine all schemas into schemaGraph for JSON-LD
