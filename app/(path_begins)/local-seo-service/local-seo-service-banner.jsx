            ...
            <div className="container">
                <div className="row localseoservicebanner">
                    <div className="col-7 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <p>Boost your business with our expert local SEO services. We optimize
                            your online presence for local searches, driving traffic and customers
                            to your doorstep.</p>
                    ...
                    <div className="col-5 col-sm-6 col-md-6 col-lg-6 text-center align-self-center element-local-image">
                        ...
                        <img src="webdads/images/local-seo-service/Img.png" alt="Img.png" loading='lazy' className='img-fluid' />
