            ...
            <div className="container">
                <div className="row localseccompany">
                    <div className="col-sm-12 col-md-6 col-lg-6 align-self-center">
                        <img src="webdads/images/local-seo-service/How-would-a-Local-SEO-Company-help-you-to-grow-Your-Business.png" alt="How-would-a-Local-SEO-Company-help-you-to-grow-Your-Business" loading='lazy' className='img-fluid' />
                    </div>
