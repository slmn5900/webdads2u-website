...
const features = [
    { title: 'User Account', img: '/webdads/images/ecommerce/user-accounts.png', type: 'left' },
    { title: 'Sign With Social Media', img: '/webdads/images/ecommerce/Sign-social.png', type: 'right' },
    { title: 'Shipping', img: '/webdads/images/ecommerce/shipping-pay.png', type: 'left' },
    { title: 'Payment', img: '/webdads/images/ecommerce/Payment.png', type: 'right' },
    { title: 'Commission Management', img: '/webdads/images/ecommerce/Search-Filter.png', type: 'left', altColor: true },
    { title: 'User Account', img: '/webdads/images/ecommerce/Search-Filter.png', type: 'right', altColor: true },
    { title: 'Push Notifications', img: '/webdads/images/ecommerce/Push-Notifications.png', type: 'left', altColor: true },
    { title: 'Multi-lingual', img: '/webdads/images/ecommerce/Multi-lingual.png', type: 'right', altColor: true },
    { title: 'Blog', img: '/webdads/images/ecommerce/Blog.png', type: 'right', altColor: true }
];
            ...
            <Container maxWidth="lg">
                ...
                <Grid2 container spacing={4}>
                    {features.map((feature, index) => (
                        <Grid2 size={{ xs: 6, md: 2.4 }} key={feature.title}>
