    ...
    return (
        ...
        >
            ...
            <Container component={motion?.div} initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: 'easeOut' }} sx={{ position: 'relative', zIndex: 2 }}>
                ...
                <Box component={'img'} sx={{ width: 400, display: { xs: 'none', md: 'block' }, m: 'auto' }} src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757575683/webdads2u/ecommerce-website-development/ecommerce-web-design.png" alt="" />
            </Container>
        </Box>
    );
}
