...
import React, { useState } from 'react';
import { Box, Typography, Button, useMediaQuery, Grid2 } from '@mui/material';
import { motion, AnimatePresence } from 'framer-motion';
...
const CircleTabs = () => {
    ...
    const radius = isMobile ? 110 : 220; // smaller radius for mobile
            ...
            <Grid2 container justifyContent="center">
                <Grid2 size={{ xs: 12, md: 8 }}>
                    <Box
                        sx={{
                            position: 'relative',
                            width: { xs: 260, md: 520 }, // circle size
                            height: { xs: 260, md: 520 },
                            mx: 'auto',
                            borderRadius: '50%',
                            border: '1px solid transparent',
