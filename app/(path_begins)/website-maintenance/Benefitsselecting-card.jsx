                    ...
                    <div className="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <Slider {...settings} className="benefitsselectingcard text-center">
                            <div className='hello'>
                                <div className="card">
                                    <div className="card-image">
                                        <img src="webdads/images/website-maintenance/ecoomerce-slider.png" alt="ecoomerce-slider" loading='lazy' className='img-fluid' />
                                    </div>
                            ...
                            <div>
                                <div className="card">
                                    <div className="card-image">
                                        <img src="webdads/images/website-maintenance/solutions.png" alt="solutions" loading='lazy' className='img-fluid' />
                                    </div>
                                    <div className="card-body">
                                        <h5 style={{
                                            color: '#0b1225',
                            ...
                            <div>
                                <div className="card">
                                    <div className="card-image">
                                        <img src="webdads/images/website-maintenance/app-development-banner.png" alt="app-development-banner" loading='lazy' className='img-fluid' />
                                    </div>
                                    <div className="card-body">
                                        <h5 style={{
                                            color: '#0b1225',
                            ...
                            <div>
                                <div className="card">
                                    <div className="card-image">
                                        <img src="webdads/images/website-maintenance/website-hosting.png" alt="website-hosting" loading='lazy' className='img-fluid' />
                                    </div>
                                    <div className="card-body">
                                        <h5 style={{
                                            color: '#0b1225',
                            ...
                            <div>
                                <div className="card">
                                    <div className="card-image">
                                        <img src="webdads/images/website-maintenance/social-media-marketing.png" alt="social-media-marketing" loading='lazy' className='img-fluid' />
                                    </div>
                                    <div className="card-body">
                                        <h5 style={{
                                            color: '#0b1225',
