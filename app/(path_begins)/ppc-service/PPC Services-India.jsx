            ...
            <div className="container">
                <div className="row ppcservicesindia align-items-start">
                    <div className="col-sm-12 col-md-6 3col-lg-6 ">
                        <img src="webdads/images/ppc-service/Graph-seo.avif" alt="Graph-seo" loading='lazy' className='img-fluid' />
                    </div>
                    <div className="col-sm-12 col-md-6 col-lg-6">
                        ...
                        <div class="d-flex flex-row mb-3 pp-item">
                            <div class="p-2 col-sm-1 col-md-1 col-lg-1 text-center align-self-center pps-item">
                            <TfiBarChart className='pps-icon'/>
                            </div>
                            <div class="p-2 col-sm-11 col-md-11 col-lg-11">
