        ...
        <div className="container">
            <div className="row justify-content-center ppcservicebanner">
                <div className="col-6 col-sm-6 col-md-6 col-lg-6 align-self-lg-center">
                    <h1>PPC Service</h1>
                    <p>Building unique, industry-specific, custom-made web
                    portals for outstanding customer experience</p>
                ...
                <img src="webdads/images/ppc-service/convertio.in_ppc-banner-right.png" alt="convertio.in_ppc-banner-right" loading='lazy' className='img-fluid pppc-image-hover'/>
