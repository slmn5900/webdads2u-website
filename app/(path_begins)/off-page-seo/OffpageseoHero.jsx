                    ...
                    <Row className="align-items-center">
                        ...
                        <Col md={12} lg={6}>
                            <div className="imageup-st">
                                <img src="/webdads/images/offpageseo/off-page-seo-about.webp" alt="Offpageseo" className="w-100" />
                            </div>
                        </Col>
                    </Row>
...
>>>>>>> 6010d3c (Add new features and updates)
                        <Col md={12} lg={6}>
                            <div className="imageup-st">
                                <img src="/webdads/images/offpageseo/optimization.webp" alt="Offpageseo" className="w-100" />
                            </div>
                        </Col>
                        <Col md={12} lg={6}>
                            <div className="">
<<<<<<< HEAD
                                ...
                                <p>
                                Best off page SEO company in Chennai will do it for our clients which increase traffics to website visibility in search engine. Off-Page Optimization is not just about links. After effectively completing on-page optimization, it’s time for you to focus on off-page optimization. So, what it is all about? Off-page optimization refers optimizing such parts search engines consider while providing the ranking preference. Main sources of external links consist of Web logs comments, links from related forums and sites,</p>
=======
