...
"
            ...
            <section className="  ">
                <Container>
                    <Row className="align-items-center">
                        ...
                        <Col md={12} lg={6}>
                            <div className="imageup-st">
                                <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497905/webdads2u/off-page-seo/off-page-seo.png" alt="off page seo" className="w-100" />
                            </div>
                        </Col>
                    </Row>
                    <Row className="pt-5 pb-5 align-items-center">
                        <Col md={12} lg={6}>
                            <div className="imageup-st">
                                <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497906/webdads2u/off-page-seo/seo-optimization.png" alt="seo optimization" className="w-100" />
                            </div>
                        </Col>
                        <Col md={12} lg={6}>
                            <div>
                ...
                <Container>
                    <Row className="align-items-center">
                        ...
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497944/webdads2u/off-page-seo/icons/seo.png" alt="mobileuiux-hero" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                                    <h3>Search Engine Submission</h3>
                                    <p>We manually submit your website to the popular search engines. It ensures the proper indexing of your website or webpages. We strictly don’t recommend automated submission, as its treated as SPAM sometimes.</p>
                                </div>
                            </div>
                        </Col>
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497941/webdads2u/off-page-seo/icons/article.png" alt="mobileuiux-hero" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                        ...
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497939/webdads2u/off-page-seo/icons/directory-submission.png" alt="mobileuiux-hero" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                        ...
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497936/webdads2u/off-page-seo/icons/classified-submission.png" alt="mobileuiux-hero" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                                    <h3>Classified submission</h3>
                                    <p>We manually submit your website to the popular search engines. It ensures the proper indexing of your website or webpages. We strictly don’t recommend automated submission, as its treated as SPAM sometimes.</p>
                                </div>
                            </div>
                        </Col>
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497933/webdads2u/off-page-seo/icons/link-building.png" alt="mobileuiux-hero" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                                    <h3>Link building </h3>
                                    <p>We manually submit your website to the popular search engines. It ensures the proper indexing of your website or webpages. We strictly don’t recommend automated submission, as its treated as SPAM sometimes.</p>
                        ...
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497930/webdads2u/off-page-seo/icons/online-branding.png" alt="mobileuiux-hero" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                                    <h3>Forums</h3>
                                    <p>We manually submit your website to the popular search engines. It ensures the proper indexing of your website or webpages. We strictly don’t recommend automated submission, as its treated as SPAM sometimes.</p>
                        ...
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497925/webdads2u/off-page-seo/icons/place.png" alt="mobileuiux-hero" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                                    <h3>Google Local Map</h3>
                                    <p>We manually submit your website to the popular search engines. It ensures the proper indexing of your website or webpages. We strictly don’t recommend automated submission, as its treated as SPAM sometimes.</p>
                                </div>
                            </div>
                        </Col>
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497923/webdads2u/off-page-seo/icons/bookmark.png" alt="bookmark" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                        ...
                        <Col md={6} lg={4}>
                            <div className="offpage-devbx">
                                <div className="isoimgbx">
                                    <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757497928/webdads2u/off-page-seo/icons/communication.png" alt="communication" style={{ width: '200px', objectFit: 'contain' }} />
                                </div>
                                <div className="isoconbx">
                                    <h3>BLOG POSTING</h3>
                                    <p>We manually submit your website to the popular search engines. It ensures the proper indexing of your website or webpages. We strictly don’t recommend automated submission, as its treated as SPAM sometimes.</p>
            ...
            <section className="looking-offpage">
                <Container>
                    <Row>
                        <div className="text-center">
