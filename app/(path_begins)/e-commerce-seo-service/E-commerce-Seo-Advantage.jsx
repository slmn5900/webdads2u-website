                ...
                <div className="row ecommerceseoadvantage">
                    <div className="col-sm-12 col-md-6 col-lg-6 align-self-lg-center">
                        ...
                        <div class="d-flex flex-row mb-3">
                            <div class="icon-color"><FaCheckCircle /></div>
                            <div class=""><p>Industry-specific e-commerce SEO plans to drive maximum potential buyers to your online store</p></div>
                        </div>

                        <div class="d-flex flex-row mb-3">
                            <div class="icon-color"><FaCheckCircle /></div>
                            <div class=""><p>Relevant SEO services to make your online store easily searchable on the web</p></div>
                        </div>

                        <div class="d-flex flex-row mb-3">
                            <div class="icon-color"><FaCheckCircle /></div>
                            <div class=""><p>Product optimization and content optimization to make your online store SEO-friendly</p></div>
                        </div>
                    </div>
