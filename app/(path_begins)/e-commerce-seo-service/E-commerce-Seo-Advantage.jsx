                ...
                <div className="row ecommerceseoadvantage">
                    <div className="col-sm-12 col-md-6 col-lg-6 align-self-lg-center">
                        ...
                        <div className="d-flex flex-row mb-3">
                            ...
                            <div ><p>Industry-specific e-commerce SEO plans to drive maximum potential buyers to your online store</p></div>
                        </div>

                        <div className="d-flex flex-row mb-3">
                            <div className="icon-color"><FaCheckCircle /></div>
                            <div ><p>Relevant SEO services to make your online store easily searchable on the web</p></div>
                        </div>

                        <div className="d-flex flex-row mb-3">
                            <div className="icon-color"><FaCheckCircle /></div>
                            <div ><p>Product optimization and content optimization to make your online store SEO-friendly</p></div>
                        </div>
                    </div>
