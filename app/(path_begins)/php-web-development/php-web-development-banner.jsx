            ...
            <div className="container">
                <div className="row php-banner">
                    <div className="col-6 col-sm-6 col-md-6 col-lg-6 align-self-lg-center p-2">
                        ...
                        <p className="mb-0">Webdads2u Technologies is best PHP web development company in Chennai, India. PHP is one of the most widely used general purpose</p>
                    ...
                    <div className="col-6 col-sm-6 col-md-6 col-lg-6 align-self-center">
                        <img src="webdads/images/php-web-development/php.png" alt="PHP Web Development Company In Chennai" loading="lazy" className="img-fluid" />
                    </div>
                </div>
            </div>
        </section>
