            ...
            <div className="row newtechnologies">
                ...
                <div className="col-sm-12 col-md-12 col-lg-6 align-self-center">
                    ...
                    <div className="d-flex flex-row newtechnologies-min">
                        ...
                        <div className="p-2 card flex-fill"><img src="webdads/images/php-web-development/PHP_ph.png" alt="PHP_ph" loading='lazy' className='img-fluid' /></div>
                        <div className="p-2 card flex-fill"><img src="webdads/images/php-web-development/PHP_php.png" alt="PHP_php" loading='lazy' className='img-fluid' /></div>
                    </div>
                    <div className="d-flex flex-row newtechnologies-min">
                        <div className="p-2 card flex-fill"><img src="webdads/images/php-web-development/PHP_jp.png" alt="PHP_jp" loading='lazy' className='img-fluid' /></div>
                        <div className="p-2 card flex-fill"><img src="webdads/images/php-web-development/PHP_p.png" alt="PHP_p" loading='lazy' className='img-fluid' /></div>
                        <div className="p-2 card flex-fill"><img src="webdads/images/php-web-development/CSS.png" alt="CSS" loading='lazy' className='img-fluid' /></div>
                    </div>
                </div>
            </div>
            </div>
