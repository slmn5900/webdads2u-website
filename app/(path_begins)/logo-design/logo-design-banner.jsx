        ...
        >
            <Container maxWidth="lg">
                <Grid2 container alignItems="center" spacing={4}>
                    ...
                    <Grid2 size={{ xs: 12, md: 6 }} sx={{ display: { xs: 'none', md: 'flex' }, justifyContent: 'center', position: 'relative' }}>
                        <Box
                            component="img"
                            src={imgs}
                        ...
                        />
                        <Box component={'img'} sx={{ position: 'absolute', width: 300, bottom: 100, transform: '50% 50%' }} src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1756889680/webdads2u/logo-design/business-logo-maker.png" alt="" />
                    </Grid2>
                </Grid2>
            </Container>
        </Box>
