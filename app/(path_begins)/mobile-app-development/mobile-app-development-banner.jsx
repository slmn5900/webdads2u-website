                    ...
                    <div className="row mobileappdevelopmentbanner">
                        <div className="col-sm-12 col-md-6 col-lg-7">
                            ...
                            <Box sx={{ display: { xs: 'none', md: 'block' } }}>
                                <div>
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175215/webdads2u/mobile-app-development/minicircle-banner-icon.svg"
                                        alt="Mobile App Development Company In Chennai"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-1   d-none d-md-block"
                                    />
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175211/webdads2u/mobile-app-development/dotmini-banner-icon.svg"
                                        alt="1"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-2   d-none d-md-block"
                                    />
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175215/webdads2u/mobile-app-development/minicircle-banner-icon.svg"
                                        alt="1"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-3   d-none d-md-block"
                                    />
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175211/webdads2u/mobile-app-development/dotmini-banner-icon.svg"
                                        alt="1"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-11  d-none d-md-block"
                                    />
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175215/webdads2u/mobile-app-development/minicircle-banner-icon.svg"
                                        alt="1"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-22  d-none d-md-block"
                                    />
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175211/webdads2u/mobile-app-development/dotmini-banner-icon.svg"
                                        alt="1"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-33  d-none d-md-block"
                                    />
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175215/webdads2u/mobile-app-development/minicircle-banner-icon.svg"
                                        alt="1"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-111 d-none d-md-block"
                                    />
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175211/webdads2u/mobile-app-development/dotmini-banner-icon.svg"
                                        alt="1"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-222 d-none d-md-block"
                                    />
                                    <img
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1758175215/webdads2u/mobile-app-development/minicircle-banner-icon.svg"
                                        alt="1"
                                        loading="lazy"
                                        className="img-fluid image-1 element-svgexport-image-333 d-none d-md-block"
                                    />
                                </div>
                            </Box>
                        </div>
                        <div className="col-5  col-sm-6 col-md-6 col-lg-5 align-self-center">
                            <Box sx={{ display: { xs: 'none', md: 'block' } }}>
                                <img
                                    src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1756884947/webdads2u/mobile-app-development/mobile-app-development-company-chennai.png"
                                    alt="mobile-app-banner"
                                    loading="lazy"
                                    style={{ width: '540px', marginTop: '2rem' }}
                                />
