        ...
        <div className="container">
            ...
            <div className="row text-center appdevelopmentservices-card">
                <div className="col-sm-12 col-md-6 col-lg-4 mb-5">
                    <div className="card">
                        <div className='card-image'>
                            <img src="webdads/images/mobile-app-development/Enhanced-User-Engagement.png" alt="Enhanced-User-Engagement" className='img-fluid'/>
                        </div>
                ...
                <div className="col-sm-12 col-md-6 col-lg-4 mb-5">
                    <div className="card">
                        <div className='card-image'>
                            <img src="webdads/images/mobile-app-development/Increased-Brand-Visibility.png" alt="Increased-Brand-Visibility" className='img-fluid' />
                        </div>
                        <div className="card-title">
                ...
                <div className="col-sm-12 col-md-6 col-lg-4 mb-5">
                    <div className="card">
                        <div className='card-image'>
                            <img src="webdads/images/mobile-app-development/Scalability.png" alt="Scalability" className='img-fluid' />
                        </div>
                        <div className="card-title">
                            <h2>Scalability</h2>
                        </div>
