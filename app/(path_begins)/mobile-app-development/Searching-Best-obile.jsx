            ...
            <div className="container">
                <div className="row SearchingBestobile-card justify-content-md-start text-center text-sm-center text-md-start">
                    <div className="col-sm-12 col-md-8 col-lg-4 ">
                        <div class="card d-flex flex-column flex-md-row flex-lg-row mb-3">
                            <div class="p-2 align-self-center"><img src="webdads/images/mobile-app-development/time.png" alt="time" className='img-fluid' /></div>
                            <div class="p-2">
                    ...
                    <div className="col-sm-12 col-md-8 col-lg-4">
                        <div class="card d-flex flex-column flex-md-row flex-lg-row mb-3">
                            <div class="p-2 align-self-center" ><img src="webdads/images/mobile-app-development/complicity.png" alt="complicity" className='img-fluid' /></div>
                            <div class="p-2"><h1>The Complexity</h1>
                                <p>Complex mobile apps require more effort from designers.</p></div>
                        </div>
                    </div>
                    <div className="col-sm-12 col-md-8 col-lg-4">
                        <div class="card d-flex flex-column flex-md-row flex-lg-row mb-3">
                            <div class="p-2 align-self-center"><img src="webdads/images/mobile-app-development/revision.png" alt="revision" className='img-fluid' /></div>
                            <div class="p-2"><h1>The Number Of Revisions</h1>
