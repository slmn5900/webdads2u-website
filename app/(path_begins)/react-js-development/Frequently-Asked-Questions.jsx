                ...
                <div className="row">
                    ...
                    <div className='FrequentlyAskedQuestions-Accordion'>
                            ...
                            <Accordion.Item eventKey="0">
                                ...
                                <Accordion.Body>
                                We employ advanced logistics and scheduling systems, coupled with a dedicated team, to ensure timely delivery of all orders.
                                </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="1">
                                <Accordion.Header>What happens if my delivery is delayed?</Accordion.Header>
                                <Accordion.Body>
                                In the rare event of a delay, we promptly communicate with you and provide updates on the status of your delivery, along with any necessary solutions or compensations.
                                </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="3">
                                <Accordion.Header>Can I track my delivery in real-time?</Accordion.Header>
                                <Accordion.Body>
                                Yes, you can track your delivery in real-time through our online tracking system, providing you with peace of mind and transparency throughout the process.
                                </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="4">
                                <Accordion.Header>Do you offer expedited shipping options for urgent orders?</Accordion.Header>
                                <Accordion.Body>
                                Yes, we offer expedited shipping options for urgent orders, ensuring your items reach you as quickly as possible when time is of the essence.
                                </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="5">
                                <Accordion.Header>Can I schedule a specific delivery time?</Accordion.Header>
                                <Accordion.Body>
                                Depending on your location and the nature of the order, we may offer the option to schedule a specific delivery time to accommodate your availability.
                                </Accordion.Body>
                            </Accordion.Item>
                        </Accordion>
                        </div>
