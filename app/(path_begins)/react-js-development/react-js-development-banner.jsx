    ...
    return (
        <Box
            ...
            sx={{
                ...
                backgroundImage: "url('https://res.cloudinary.com/dbpv95wd8/image/upload/v1757393352/webdads2u/react-js-development/banner-background.webp')",
            ...
            <Container maxWidth="lg">
                <Grid2 container spacing={4} alignItems="center">
                    ...
                    <Grid2 size={{ xs: 12, md: 5 }} sx={{ position: 'relative', display: { xs: 'none', md: 'block' } }}>
                        {/* Background Image */}
                        <motion.img
                            src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757483780/webdads2u/react-js-development/react-js.png"
                        ...
                        {/* Top Logo Image */}
                        <motion.img
                            src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757393352/webdads2u/react-js-development/ball-icons.png"
                            alt="WordPress Development Company In Chennai"
                            loading="lazy"
