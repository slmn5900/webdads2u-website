                ...
                <div className="row digitalmarketingagencybanner">
                    <div className="col-6 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div className='d-none d-sm-block'>
                            <a href="/contact-us"><button className='button-one'>SCHEDULE A DEMO</button></a><a href="/contact-us"><button className='button-two'>CHECK WEBDADS2U PROMISE</button></a>
                        </div>
                    </div>
                    <div className="col-6 col-sm-6 col-md-6 col-lg-6 align-self-center">
                        <img src="webdads/images/digital-marketing-agency/banner-design.png" alt="banner-design" loading='lazy' className='img-fluid' />
                    </div>
                </div>
            </div>
        </section>
