...
//                                             communication and transactions between businesses. With a focus on user experience and functionality, we ensure that your B2B portal meets the unique needs of your organization. Contact us today to get
//                                             started!
//                                         </p>
//                                     </div>
//                                     <div className="cont">
...
//                                         <p>
//                                             Need a B2C Web Portal Development solution? We’ve got you covered! Our experienced team specializes in Web Portal Development for B2C purposes. We create custom portals that provide a user-friendly
//                                             interface for customers to interact with your products or services. From e-commerce platforms to service marketplaces, we ensure your B2C portal is optimized for performance and user satisfaction. Contact
...
//                                         <br />
//                                         <h6>
//                                             Vendor Portal <br></br>Development
//                                         </h6>
//                                     </div>
//                                 }
//                             >
...
//                                         <p>
//                                             Seeking Vendor Web Portal Development? We’re your solution! Our team excels in Web Portal Development customized for vendors. We create intuitive portals that streamline communication and transactions
//                                             between your business and its vendors. With our expertise, your vendor portal will enhance efficiency and collaboration. Contact us today to start building your vendor portal!
//                                         </p>
//                                     </div>
//                                     <div className="cont">
...
//                                             eCommerce Portal <br></br>Development
//                                         </h6>
//                                     </div>
//                                 }
//                             >
...
//                                         <p>
//                                             Our eCommerce web portal development solutions are designed to empower businesses with a wide range of features, including multi-vendor marketplaces, trade portals, auction and bidding platforms, and custom
//                                             solutions. Leveraging the latest technologies such as AR/VR and AI, we ensure that your portal is equipped with cutting-edge capabilities to drive growth and enhance user experiences. Explore the endless
//                                             possibilities for your eCommerce venture!
//                                         </p>
//                                     </div>
//                                     <div className="cont">
...
//                                         <br />
//                                         <h6>
//                                             Travel Portal<br></br> Development
//                                         </h6>
//                                     </div>
//                                 }
//                             >
...
//                                         <p>
//                                             Embark on a journey with our Travel Web Portal Development services! Our team specializes in Web Portal Development tailored for the travel industry. We create intuitive portals that provide seamless
//                                             booking experiences for travelers. From flight and hotel reservations to tour packages, our travel portals are designed to enhance efficiency and customer satisfaction. Contact us today to get started!
//                                         </p>
//                                     </div>
//                                     <div className="cont">
                    ...
                    <Tabs activeKey={activeKey} onSelect={(k) => setActiveKey(k || '')} transition={false} id="webportal-tabs" className="mb-3">
                        ...
                        >
                            {renderContent(
                                ...
                                '/webdads/images/webportal/B2B.webp'
                            )}
                        </Tab>
