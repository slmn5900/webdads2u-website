            ...
            <Grid2 container spacing={4} alignItems="center">
                ...
                <Grid2 size={{ xs: 12, md: 6 }} sx={{ display: { xs: 'none', md: 'block' } }}>
                    <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                        {/* Phone Image */}
                        <motion.img
                            src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757573269/webdads2u/react-native-app-development/react-native-app-development.png"
                        ...
                        <motion.img
                            src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757573274/webdads2u/react-native-app-development/react-native.png"
                            alt="react native"
                            style={{
                                position: 'absolute',
                                bottom: '280px',
