            ...
            <div className="container">
                <div className="row brandidentity-card">
                    <div className="col-lg-4">
                        <div className="card">
                            <img src="/webdads/images/branding-design/creativity.png" className="img-fluid" alt="Creative Ideas" />
                    ...
                    <div className="col-lg-4">
                        <div className="card">
                            <img src="/webdads/images/branding-design/customize-layout.png" className="img-fluid" alt="Customize Layout" />
                            <div className="card-body">
                    ...
                    <div className="col-lg-4">
                        <div className="card">
                            <img src="/webdads/images/branding-design/attract-customer.png" className="img-fluid" alt="Attract Customers" />
                            <div className="card-body">
