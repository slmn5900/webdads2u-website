                            ...
                            <div className="col-xs-12 col-lg-6 mt-5" style={{ marginRight: '25px' }}>
                                <Card>
                                    <Card.Body>
                                        <div>
                                            {' '}
                                            <img src="/webdads/images/branding-design/Professional-typography.png" alt="Professional-typography" className="img-fluid" />
                                        </div>
                                ...
                                <Card>
                                    <Card.Body>
                                        <div>
                                            {' '}
                                            <img src="/webdads/images/branding-design/on-brand-supporting.png" alt="on-brand-supporting" className="img-fluid" />
                                        </div>
                            ...
                            <div className="col-xs-12 col-lg-6 ">
                                <Card>
                                    <Card.Body>
                                        <div>
                                            {' '}
                                            <img src="/webdads/images/branding-design/colour-palette.png" alt="colour-palette" className="img-fluid" />
                                        </div>
                                ...
                                <Card>
                                    <Card.Body>
                                        <div>
                                            {' '}
                                            <img src="/webdads/images/branding-design/system.png" alt="system" className="img-fluid" />
                                        </div>
