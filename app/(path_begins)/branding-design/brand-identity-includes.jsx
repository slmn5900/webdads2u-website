            ...
            <div className="container">
                <div className="row BrandIdentityIncludes">
                    <div className="col-sm-12 col-lg-6">
                        <h1>What Does</h1>
                        <h1><span className='BrandIdentityIncludes-span'>brand identity</span> includes</h1>
                        <p>Сorporate identity elements can further maximize
                            the impact of the marketing activities.</p>
                    ...
                    <div className="col-xs-12 col-sm-12 col-lg-6  BrandIdentityIncludes-card-colum">
                        <div class="d-flex flex-column flex-sm-row text-center BrandIdentityIncludes-card">
                            <div class="col-xs-12 col-lg-6 mt-5">
                                ...
                                <Card >
                                    <Card.Body>
                                    <div> <img src="/webdads/images/branding-design/on-brand-supporting.png" alt="on-brand-supporting" className='img-fluid'/></div>
                                        <Card.Title>On-brand supporting Graphics</Card.Title>
                                        <Card.Text>
                                        It is a variety of graphic elements which convey a business’ visual language. These can be images, icons, buttons, motion graphics, data visualization, or design assets.
                                        </Card.Text>
                                    </Card.Body>
                                </Card>
                            </div>
                            <div class="col-xs-12 col-lg-6">
                                ...
                                <Card >
                                    <Card.Body>
                                    <div> <img src="/webdads/images/branding-design/system.png" alt="system" className='img-fluid'/></div>
                                        <Card.Title>Design System</Card.Title>
                                        <Card.Text>
                                        When all elements have been chosen or created you need a system to bring them together. It makes text and graphic messages clear for customers.
                                        </Card.Text>
                                    </Card.Body>
                                </Card></div>
                        </div>
