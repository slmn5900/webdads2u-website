...
export default function WaveBox() {
    const data = [
        {
            img: '/webdads/images/crm/CRM-Software-Solutions.png',
        ...
        {
            img: '/webdads/images/crm/CRM-Maintenance.png',
        ...
        {
            img: '/webdads/images/crm/integration.png',
        ...
        {
            img: '/webdads/images/crm/Layer-146.png',
        ...
        {
            img: '/webdads/images/crm/CRM-Mobile-Application.png',
        ...
        {
            img: '/webdads/images/crm/CRM-Migration-Solutions.png',
