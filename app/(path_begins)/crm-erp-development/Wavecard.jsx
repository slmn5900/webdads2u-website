                    ...
                    <Row>
                        ...
                        <Col md={4}>
                            <div className="crm-box">
                                <div className="d-flex">
                                    <img
                                        src="/webdads/images/crm/integration.png"
                                        alt="Best CRM For Small Businesses | NO 1 CRM Software Platforms
"
                                    />
                    ...
                    <Row className="pt-5 ">
                        ...
                        <Col md={3}>
                            <div className="text-center strategic">
                                ...
                                <p>Operational CRM streamlines day-to-day customer-facing processes, such as sales, marketing, and service automation. The best CRM for small businesses optimizes operational efficiency.</p>
                            </div>
                        </Col>
                        <Col md={3}>
                            <div className="text-center strategic strt">
                                ...
                                <p>Collaborative CRM emphasizes cross-departmental communication and teamwork to enhance customer relationships. It ensures a unified approach, where teams share customer information seamlessly.</p>
                            </div>
                        </Col>
                    </Row>
                </Container>
                        ...
                        <Col md={6}>
                            ...
                            <div className="d-flex cust-web">
                                <div>
                                    ...
                                    <p>
                                        <FaCircleCheck /> Finance
                                    </p>
                                    <p>
                                        <FaCircleCheck /> Procurement
                                    </p>
                                    <p>
                                        <FaCircleCheck /> Manufacturing
                                    </p>
                                    <p>
                                        <FaCircleCheck /> Inventory Management
                                    </p>
                                    <p>
                                        <FaCircleCheck /> Workforce Management
                                    </p>
                                    <p>
                                ...
                                <div>
                                    ...
                                    <p>
                                        <FaCircleCheck /> Warehouse Management
                                    </p>
                                    <p>
                                        <FaCircleCheck /> Supply Chain Management
                                    </p>
                                    <p>
                                        <FaCircleCheck /> CRM & Sales
                                    </p>
                                    <p>
                                        <FaCircleCheck /> Marketing Automation
                                    </p>
                                    <p>
                                        <FaCircleCheck /> Distribution
                                    </p>
                                </div>
                            </div>
                        </Col>
