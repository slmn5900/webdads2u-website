        ...
        <section className="customwebsitedevelopment-main">
                    ...
                    <div className="col-sm-12 col-md-8 col-lg-8 customwebsitedevelopment-card">
                        <div className="d-flex flex-row mb-3 text-center element">
                            <div className="card m-2">
                                <div>
                                    <img src="webdads/images/custom-web-development/Web-Hosting.png" alt="Web-Hosting" loading="lazy" className="img-fluid" />
                                </div>
                                <h5>Web Hosting</h5>
                            ...
                            <div className="card m-2">
                                <div>
                                    <img src="webdads/images/custom-web-development/Web-Development.png" alt="Web-Development" loading="lazy" className="img-fluid" />
                                </div>
                        ...
                        <div className="d-flex flex-row mb-3 text-center element">
                            <div className="card m-2">
                                <div>
                                    <img src="webdads/images/custom-web-development/Mobile-App-Development.png" alt="Mobile-App-Development" loading="lazy" className="img-fluid" />
                                </div>
                            ...
                            <div className="card m-2">
                                <div>
                                    <img src="webdads/images/custom-web-development/Digital-Marketing.png" alt="Web-Development" loading="lazy" className="img-fluid" />
                                </div>
            ...
            {/* <div className="container">
                <div className="row align-items-center">
                    ...
                    <div className="col-sm-12 col-md-8 col-lg-8 customwebsitedevelopment-card">
                        <div className="row">
                            <div className="col-sm-12 col-md-6 mb-3 text-center element">
                                <div className="card m-2">
                                    <div>
                                        <img src="webdads/images/custom-web-development/Web-Hosting.png" alt="Web-Hosting" loading="lazy" className="img-fluid" />
                                    </div>
