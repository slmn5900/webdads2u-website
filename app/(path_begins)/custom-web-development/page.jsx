...
import CustomeWebDevelopermenets from './CustomeWebDevelopermenets';

export const metadata = {
    alternates: {
        canonical: 'https://www.webdads2u.com/custom-web-development'
    },
...
const page = () => {
    return <CustomeWebDevelopermenets />;
};
