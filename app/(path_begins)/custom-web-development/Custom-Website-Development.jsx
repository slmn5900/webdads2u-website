...
function Customwebsitedevelopment() {
    return (
        <section className='customwebsitedevelopment-main'>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-sm-12 col-md-8 col-lg-8 customwebsitedevelopment-card">
                        <div className="d-flex flex-row mb-3 text-center element">
                            <div className="card m-2"><div><img src="webdads/images/custom-web-development/Web-Hosting.png" alt="Web-Hosting" loading='lazy' className='img-fluid'/></div>
                            <h5>Web Hosting</h5>
                            <p>Reliable and secure web hosting services to ensure your website is always up and running smoothly.</p>
                            </div>
                            <div className="card m-2"><div><img src="webdads/images/custom-web-development/Web-Development.png" alt="Web-Development" loading='lazy' className='img-fluid'/></div>
                            <h5>Web Development</h5>
                            <p>Stunning and user-friendly web design that captures your brand identity and engages your audience.</p>
                            </div>
                        </div>
                        <div className="d-flex flex-row mb-3 text-center element">
                            <div className="card m-2"><div><img src="webdads/images/custom-web-development/Mobile-App-Development.png" alt="Mobile-App-Development" loading='lazy' className='img-fluid'/></div>
                            <h5>Mobile App Development</h5>
                            <p>Comprehensive web development services to build scalable and feature-rich websites and web applications.</p>
                            </div>
                            <div className="card m-2"><div><img src="webdads/images/custom-web-development/Digital-Marketing.png" alt="Web-Development" loading='lazy' className='img-fluid'/></div>
                            <h5>Web Hosting</h5>
