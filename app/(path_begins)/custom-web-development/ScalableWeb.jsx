...
function Scalableweb() {
    return (
        <section className="scalableweb-main">
            <div className="container">
                <div className="row text-center">
                    <div className="col-sm-12 col-md-12 col-lg-12 text-center scalableweb">
                        <h3>Scalable Web Application Development Frameworks</h3>
                    </div>
                </div>
