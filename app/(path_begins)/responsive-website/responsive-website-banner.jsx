            ...
            <div className="container">
                <div className="row responsivewebsitebanner">
                    <div className="col-7 col-sm-6 col-md-6 col-md-6 align-self-center">
                        <h1>Leading Responsive Website
                            Designing Company</h1>
                        <p>As a leading responsive website designing company, we specialize in creating
                            visually stunning and user-friendly websites that adapt seamlessly across all devices.
                            Our team combines expertise in responsive web design with innovative techniques to
                            ensure your website delivers an exceptional user experience on desktops, tablets, and
                            smart phones.</p>
                    ...
                    <div className="col-5 col-sm-6 col-md-6 col-md-6 align-self-center">
                        ...
                        <img src="webdads/images/responsive-website/Bubbles.png" alt="Bubbles" loading='lazy' className='img-fluid element-bubbles' />
                        </div>
                    </div>
                </div>
            </div>
