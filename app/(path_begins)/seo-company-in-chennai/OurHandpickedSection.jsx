...
//                                 <Box component="img" src={item.img_2} sx={{ width: '100%', height: '400px', objectFit: 'cover' }} />
//                             </Box>
//                         ))}{' '}
//                     </Grid2>
...
//                         {list.map((item, index) => (
//                             <Box sx={{ width: '100%' }} key={index}>
//                                 <Box component="img" src={item.img_1} sx={{ width: '100%', height: '400px', objectFit: 'cover' }} />
//                             </Box>
//                         ))}{' '}
//                     </Grid2>
...
//                         {list.map((item, index) => (
//                             <Box sx={{ width: '100%' }} key={index}>
//                                 <Box component="img" src={item.img_3} sx={{ width: '100%', height: '400px', objectFit: 'cover' }} />
//                             </Box>
//                         ))}{' '}
//                     </Grid2>
//                 </Grid2>
    ...
    return (
        ...
        >
            <Container>
                ...
                {/* Images Row */}
                <Grid2 container spacing={2} sx={{ pt: { xs: 2, md: 3 } }}>
                    {list.map((item, index) => {
                        // Get the key (img_1 / img_2 / img_3) and its value dynamically
                        const [key, src] = Object.entries(item).find(([k]) => k.startsWith('img')) || [];
                        const alt = item.alt || 'Handpicked image';

                        return (
                            <Grid2 key={index} size={{ xs: 12, sm: 4, md: 4 }}>
                                <Box sx={{ width: '100%' }}>
                                    <Box
                                        component="img"
                                        src={src}
