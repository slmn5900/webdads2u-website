            ...
            <div className="container">
                <div className="row htmlbanner">
                    <div className="col-7 col-sm-6 col-md-6 col-lg-6 align-self-center">
                        <h1>
                            Are You Looking For <br className="d-none d-sm-block" />
                            HTML Web Design{' '}
                        </h1>
                        <p>With our best html5 web development services, Webdads2u is able to take on any size web development project or challenge and get it delivered in HTML5.</p>
                        <a href="/contact-us">
                    ...
                    <div className="col-5 col-sm-6 col-md-6 col-lg-6 align-self-center">
                        <img
                            src="webdads/images/HTML5/html-banner-avatar.png"
                            alt="Html5 Web Development Company In Chennai 
"
                            loading="lazy"
                            className="img-fluid"
                        />
