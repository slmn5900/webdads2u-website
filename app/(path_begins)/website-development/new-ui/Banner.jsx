...
const leftColumn = [
    { src: '/webdads/images/website-development/webdevelopment-banner-service2.png', align: 'end' },
    { src: '/webdads/images/website-development/webdevelopment-banner-service1.png', align: 'center' }
];

const centerColumn = [{ src: '/webdads/images/website-development/Vector-website.png', align: 'center', isMain: true }];

const rightColumn = [
    { src: '/webdads/images/website-development/webdevelopment-banner-service4.png', align: 'start' },
