...
function WebsitedevHero() {
  return (
    ...
    <section className='our-web'>
      ...
      <p>Welcome to our web development stream! Join us as we explore the dynamic realm of web development services, covering everything from front-end design to back-end functionality. Whether you’re a beginner or a seasoned pro, we’ll share insights, tips, and the latest industry trends to help you craft engaging, high-quality websites. Expect deep dives into frameworks, programming languages, responsive design, SEO strategies, and real-world projects that highlight the importance of top-notch web development services. Tune in regularly to stay updated and elevate your web development skills with us!
      </p>
      </div>
      <div className="d-flex look-btn">
        ...
        <div className="">
          <a href="/contact-us"><button>Talk To Our UI/UX Consultants</button></a>
        </div>
      </div>
      </Col>
