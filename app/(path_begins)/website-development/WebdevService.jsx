  ...
  <section >
    <Container>
       ...
       <div className="webdev-cont">
        ...
        <p>All you need to keep your website 100% Secure and updated chnologies like JavaScript, PHP, and frameworks like React.js and WordPress drive creativity,
        crafting captivating digital realms.</p>
       </div>
