...
"
                                        src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506309/webdads2u/business-card-design/icons/shop-by-elegance-size-and-profes.png"
                                    ></img>
                                </div>
                        ...
                        <Col md={6} className="mt-2">
                            <div className="busbox">
                                <div className="busnimg">
                                    <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506309/webdads2u/business-card-design/icons/networking-business-cards.png"></img>
                                </div>
                                <div className="buscont">
                        ...
                        <Col md={6} className="mt-2">
                            <div className="busbox">
                                <div className="busnimg">
                                    <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506309/webdads2u/business-card-design/icons/appointment-business-cards.png"></img>
                                </div>
                                <div className="buscont">
                        ...
                        <Col md={6} className="mt-2">
                            <div className="busbox">
                                <div className="busnimg">
                                    <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506309/webdads2u/business-card-design/icons/qr-code-business-cards.png"></img>
                                </div>
                                <div className="buscont">
                        ...
                        <Col md={6} className="mt-2">
                            <div className="busbox">
                                <div className="busnimg">
                                    <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506309/webdads2u/business-card-design/icons/Standard-Business-Cards_nj2uog.png"></img>
                                </div>
                                <div className="buscont">
                        ...
                        <Col md={6} className="mt-2">
                            <div className="busbox">
                                <div className="busnimg">
                                    <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506308/webdads2u/business-card-design/icons/embossed-business-cards.png"></img>
                                </div>
                                <div className="buscont">
            ...
            <section style={{ background: '#f5f5f5' }} className="why-choose pt-5 pb-5">
                <Container>
                    <Row className="align-items-center">
                        <Col md={12} lg={6}>
                            <div>
                                <img src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757505999/webdads2u/business-card-design/business-card-designing.png" alt="business card designing" className="w-100"></img>
                            </div>
                        </Col>
                        <Col md={12} lg={6}>
                            <div>
                                ...
                                <p className="businessCardHero-why-choose-us pt-2">
            ...
            <section className="businesscdr pt-5 pb-5">
                <Container>
                    <Row>
                        ...
                        <Col md={6} lg={4}>
                            <div className="shopify-weoffer">
                                <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506308/webdads2u/business-card-design/icons/decorated-business-cards.png"></img>
                        ...
                        <Col md={6} lg={4}>
                            <div className="shopify-weoffer">
                                <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506308/webdads2u/business-card-design/icons/premium-business-cards.png"></img>
                        ...
                        <Col md={6} lg={4}>
                            <div className="shopify-weoffer">
                                <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506308/webdads2u/business-card-design/icons/wild-format-business-cards.png"></img>
                        ...
                        <Col md={6} lg={4}>
                            <div className="shopify-weoffer">
                                <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506308/webdads2u/business-card-design/icons/gadget-business-cards.png"></img>
                        ...
                        <Col md={6} lg={4}>
                            <div className="shopify-weoffer">
                                <img alt="" src="https://res.cloudinary.com/dbpv95wd8/image/upload/v1757506308/webdads2u/business-card-design/icons/gp-business-cards.png"></img>
