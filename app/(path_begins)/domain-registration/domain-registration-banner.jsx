            ...
            <div className="container">
                <div className="row domainregistrationbanner">
                    <div className="col-6 col-sm-6 col-md-6 col-lg-7 align-self-lg-center">
                        ...
                        <p>Own your unique space on the internet with our extensive selection of domain
                            names. Our team of experts is at your disposal to assist in selecting a domain name
                            that is catchy, memorable, and perfect for your business</p>
                    ...
                    <div className="col-6 col-sm-6 col-md-6 col-lg-5 align-self-center">
                        <img src="webdads/images/domain-registration/Banner-img.png" alt="Banner-img" loading='lazy' className='img-fluid' />
                    </div>
                </div>
            </div>
        </section>
