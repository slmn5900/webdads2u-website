            ...
            <div className="container">
                <div className="row rightdomain">
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-6 align-self-center">
                        ...
                        <ul className='p-0'>
                            <li> <FaCheckCircle className='item-icon' /> Keep your name easy to remember</li>
                            <li> <FaCheckCircle className='item-icon' /> Choose a name that fits your brand</li>
                            <li> <FaCheckCircle className='item-icon' /> Register alternative TLDs for brand protection</li>
                            <li> <FaCheckCircle className='item-icon' /> Register common domain misspellings</li>
                        </ul>
