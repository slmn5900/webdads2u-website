...
function BrochureFaq() {
    ...
    // FAQ data array for cleaner code
    const faqItems = [
        {
            question: 'What services does your brochure design company offer?',
            answer: 'At Webdads2u Private Limited, we offer a comprehensive range of brochure design services tailored to meet your specific needs. Our services include conceptualization, design, layout, copywriting, and printing management, ensuring a seamless and hassle-free experience for our clients.'
        },
        {
            question: 'How do you ensure that the brochure design aligns with our brand identity?',
            answer: 'We take great care to understand your brand identity, values, and objectives before embarking on any design project. Our team conducts thorough research and collaborates closely with you to ensure that every aspect of the brochure design reflects and enhances your brand identity.'
        },
        {
            question: 'What is the typical turnaround time for a brochure design project?',
            answer: 'The turnaround time for a brochure design project depends on various factors such as the complexity of the design, the number of revisions required, and the printing process. However, we strive to deliver high-quality designs within agreed-upon timelines to meet your marketing objectives effectively.'
        },
        {
            question: 'Can you accommodate rush orders for urgent projects?',
            answer: "Yes, we understand that sometimes you may have urgent deadlines or last-minute requirements. Our team is equipped to handle rush orders and can prioritize your project to ensure timely delivery without compromising on quality. Simply reach out to us, and we'll do our best to accommodate your needs."
        },
        {
            question: 'What sets your brochure design company apart from others in the industry?',
            answer: 'At Webdads2u Private Limited, we pride ourselves on our creativity, attention to detail, and commitment to customer satisfaction. Our experienced designers combine artistic flair with strategic thinking to deliver standout brochure designs that leave a lasting impression. Additionally, we offer personalized service, transparent communication, and competitive pricing, making us the preferred choice for businesses seeking exceptional brochure design solutions.'
        },
        {
            question: 'What is domain expiration?',
            answer: 'Domain expiration is when your domain registration period ends, and you must renew it to maintain ownership.'
        }
    ];

    return (
        <Box mt={8} mb={8} sx={{ backgroundColor: theme.palette.background.paper }}>
            <Container>
                <Grid2 container spacing={4} alignItems="flex-start">
                    ...
                    <Grid2 size={{ xs: 12, md: 5 }}>
                        <Box sx={{ py: 2, px: 5, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 3 }}>
                            ...
                            >
                                We meticulously ensure that every aspect of your brochure design resonates with your brand identity and objectives.
                            </Typography>
                        </Box>
                    </Grid2>
