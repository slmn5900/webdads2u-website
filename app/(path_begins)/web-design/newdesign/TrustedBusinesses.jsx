...
const TrustedBusinesses = () => {
    ...
    return (
        <Container maxWidth="md" sx={{ backgroundColor: 'white', pt: 2, position: 'relative', top: -50, borderRadius: 2 }}>
                        ...
                        >
                            {logos.map((img, index) => (
                                <SwiperSlide key={index}>
                                    <img src={`webdads/images/android-app-development/${img}`} alt={`client-logo-${index + 1}`} loading="lazy" />
                                </SwiperSlide>
                            ))}
                        </Swiper>
                    </Box>
