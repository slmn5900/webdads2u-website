            ...
            <Grid2 container spacing={4} alignItems="flex-start">
                ...
                <Grid2 size={{ xs: 12, md: 8 }}>
                        ...
                        {industries.map((industry, index) => (
                            <Grid2 size={{ xs: 6, sm: 6, md: 4 }} key={index}>
                                <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.4, delay: index * 0.1 }}>
                                    ...
                                    >
                                        <FaCheckCircle color="#1976d2" /> {industry}
                                    </Link>
                                </motion.div>
                            </Grid2>
                        ))}
                    ...
                    <Grid2 size={{ xs: 12, md: 4 }}>
                        <motion.img
                            src="webdads/images/android-app-development/Industry-specific-Android-Application-Development-Services.png"
                            alt="Industry-specific Android App Development"
                            loading="lazy"
