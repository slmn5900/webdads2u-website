...
const AndroidAppDevelopmentServices = dynamic(
  () => import('./Android-App-Development-Services'),
  { ssr: false }
)

const AndroidAppServices = dynamic(
  () => import('./Android-App-Services'),
  { ssr: false }
)

const AndroidApplicationDevelopmentServices = dynamic(
  () => import('./Android-Application-Development-Services'),
  { ssr: false }
)

const Webdads2uTechnologies = dynamic(
  () => import('./Webdads2u-Technologies'),
  { ssr: false }
)

const TypesofCustomAndroid = dynamic(
  () => import('./Types-of-Custom-Android'),
  { ssr: false }
)

const AndroidApp = dynamic(
  () => import('./Android-App'),
  { ssr: false }
)
...
const Slider = dynamic(
  () => import('../../../components/common/Slider-image'),
  { ssr: false }
)

const SocialMedia = dynamic(
  () => import('../../../components/common/SocialMedia'),
  { ssr: false }
)
