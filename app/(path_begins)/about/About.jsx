        ...
        <Box sx={{ mt: 3 }}>
            ...
            {/* <Container sx={{ my: 4 }}>
                <Grid2 container spacing={4}>
                    {[
                        { title: 'Mission', url: '/webdads/images/about-page/misson-about.avif', overlay: 'https://res.cloudinary.com/dbpv95wd8/images/c_scale,w_248,h_248,dpr_1.5/f_auto,q_auto/v1706706547/Mission-01-01/Mission-01-01.png?_i=AA' },
                        { title: 'Vision', url: '/webdads/images/about-page/vission.avif', overlay: 'https://res.cloudinary.com/dbpv95wd8/images/c_scale,w_248,h_248,dpr_1.5/f_auto,q_auto/v1706706537/Vission-01-01/Vission-01-01.png?_i=AA' },
                        { title: 'Goals', url: ' /webdads/images/about-page/goal.avif', overlay: 'https://res.cloudinary.com/dbpv95wd8/images/c_scale,w_248,h_248,dpr_1.5/f_auto,q_auto/v1706706556/Goal-01-01/Goal-01-01.png?_i=AA' }
                    ].map((item, index) => (
                        <Grid2 size={{ xs: 12, md: 4 }} key={index}>
                            <motion.div whileHover={{ scale: 1.02 }} transition={{ duration: 0.3 }}>
                                <Card sx={{ height: '100%', maxHeight: '500px', boxShadow: 3, position: 'relative' }}>
                                    <CardMedia component="img" height="200" image={item.url} alt={`${item} Image`} />
                                    <CardContent>
                                        <Typography variant="h5" sx={{ height: '100%', maxHeight: '500px', top: 0, bottom: 0, fontWeight: 600, mb: 2, position: 'absolute', background: '#00000045' }}>
                                            {item.title}
                                        </Typography>
                                        <Box component={'img'} src={item?.overlay} alt="" sx={{ position: 'absolute', width: '100px', left: '40%', right: '50%', top: '40%' }} />
