...
import { AppBar, Box, Toolbar, Typography, Menu, MenuItem, IconButton, Button, Stack, Tooltip, CssBaseline, Drawer, useMediaQuery, useTheme, Accordion, AccordionSummary, AccordionDetails, Link } from '@mui/material';
                    ...
                    <Toolbar sx={{ justifyContent: 'space-between' }}>
                        ...
                        {!isMobile && (
                            <Stack direction="row" alignItems="center" spacing={3}>
                                {/* Dropdown Menus */}
                                <React.Fragment>
                                    <Button onClick={handleMenuOpen(setAboutAnchorEl)} endIcon={<ArrowDropDownIcon />} sx={{ color: 'black', textTransform: 'capitalize', fontFamily: 'Poppins', fontSize: '15px' }}>
                                        About
                                    </Button>
                                    <Menu anchorEl={aboutAnchorEl} open={Boolean(aboutAnchorEl)} onClose={handleMenuClose(setAboutAnchorEl)} PaperProps={{ sx: { width: 'min-content', px: 2 } }}>
                                        {About.map((item, i) => (
                                            <Box component={Link} key={i} href={item.link} sx={{ textDecoration: 'none', color: 'black ' }}>
                                ...
                                <React.Fragment>
                                    <Button onClick={handleMenuOpen(setServicesAnchorEl)} endIcon={<ArrowDropDownIcon />} sx={{ color: 'black', textTransform: 'capitalize', fontFamily: 'Poppins', fontSize: '15px' }}>
                                        Services
                                    </Button>
                                    <Menu
                                            ...
                                            {servicesDropdownDatas.map((group) => (
                                                <Box key={group.label}>
                                                    ...
                                                    {group.items.map((item, i) => (
                                                        <Box component={Link} key={i} href={item.link} sx={{ textDecoration: 'none', color: 'black ' }}>
                                                            <MenuItem key={item.label} onClick={handleMenuClose(setServicesAnchorEl)} sx={{ fontSize: '13px', fontFamily: 'Poppins' }}>
                                                                <KeyboardDoubleArrowRightRoundedIcon sx={{ mr: 1 }} fontSize="small" />
                                                                {item.label}
                                                            </MenuItem>
                                                        </Box>
                                ...
                                <React.Fragment>
                                    <Button onClick={handleMenuOpen(setWorkAnchorEl)} endIcon={<ArrowDropDownIcon />} sx={{ color: 'black', textTransform: 'capitalize', fontFamily: 'Poppins', fontSize: '15px' }}>
                                        Work
                                    </Button>
                                ...
                                <Stack direction="row" spacing={1} alignItems="center">
                                    ...
                                    <Stack direction="row" spacing={1} alignItems="center">
                                        ...
                                        >
                                            <Box component={Link} href="tel:+91-8825607550" sx={{ textDecoration: 'none', color: 'white' }}>
                                        ...
                                        <Typography variant="body2" sx={{ fontFamily: 'Poppins', color: '#262250', fontSize: '12px' }}>
                                            ...
                                            <Box component={Link} href="tel:+91-8825607550" sx={{ textDecoration: 'none', color: '#262250' }}>
                ...
                <Box sx={{ width: 280, p: 1, fontFamily: 'Poppins' }} role="presentation">
                    <Stack spacing={2}>
                        ...
                        <Accordion sx={{ boxShadow: 'none' }}>
                            ...
                            <AccordionDetails>
                                {About.map((item, i) => (
                                    <Box component={Link} key={item.i} href={item.link} sx={{ textDecoration: 'none', color: 'black ' }}>
                        ...
                        <Accordion defaultExpanded sx={{ boxShadow: 'none' }}>
                            ...
                            <AccordionDetails sx={{ maxHeight: '60vh', overflowY: 'auto' }}>
                                {servicesDropdownDatas.map((group, i) => (
                                    <Box key={group.label} sx={{ mb: 2 }}>
                                        ...
                                        <Stack spacing={0.5}>
                                            {group.items.map((item) => (
                                                <Box component={Link} key={item.label} href={item.link} sx={{ textDecoration: 'none', color: 'black ' }}>
                                                    <MenuItem
