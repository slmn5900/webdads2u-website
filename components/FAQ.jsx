                            ...
                            <AccordionSummary
                                ...
                                expandIcon={
                                    expanded === `panel${index}` ? (
                                        ...
                                        <AddIcon style={{ color: '#000', fontSize: '1.25rem', fontWeight: 'bold' }} />
                                    )
                                }
                                className=""
                            >
                                <Typography sx={{ fontFamily: "Poppins" }}>{data.headerContent}</Typography>
                            </AccordionSummary>
                            <AccordionDetails className="accordion-body" sx={{ fontFamily: "Poppins" }}>
                                {data.boadyContent}
                            </AccordionDetails>
                        </Accordion>
                    ))}
                    ...
                    <Carousel className="carousel-parent-container-home">
                        {testimonials.map((testimonial, index) => (
                            <Carousel.Item key={index} className="carousel-item-container">
                                ...
                                <Carousel.Caption
                                    className="landing-page-testimonial-carousel-caption"
