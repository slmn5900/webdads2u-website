...
const rightLinks = [
  {
    ...
    items: [
      ...
      { name: 'ReactJs Web Development', link: '/react-js-development/' },
      { name: 'PHP Web Development', link: '/php-web-development/' },
    ...
    subItems: [
      ...
      { name: 'Hosting', link: '/web-hosting-service/' },
      { name: 'Custom Web Design', link: '/custom-web-design/' },
      { name: 'Responsive Website', link: '/responsive-website/' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'E-Commerce SEO Service', link: '/e-commerce-seo-service/' },
      { name: 'Local SEO Service', link: '/local-seo-service/' },
      { name: 'Off Page SEO', link: '/services/off-page-seo' },
      { name: 'Link Building Service', link: '/link-building-service/' },
    ...
    subItems: [
      ...
      { name: 'Corporate Gifts Design', link: '/corporate-gifts-design/' },
      { name: 'Business Card Design', link: '/business-card-design/' },
      { name: 'Letterhead Design', link: '/letterhead-design/' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Flutter App Development', link: '/flutter-app-development/' },
      { name: 'React Native App Development', link: '/react-native-app-development/' },
